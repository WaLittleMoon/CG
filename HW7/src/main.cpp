    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (ImGui::BeginMenuBar())
        {
            if (ImGui::BeginMenu("Change"))
            {
                ...
                if(ImGui::MenuItem("HW2", NULL, &isHW2))    {isHW3=false;isHW4=false;isHW5=false;isHW6=false;isHW7=false;}
                if(ImGui::MenuItem("HW3", NULL, &isHW3))    {isHW2=false;isHW4=false;isHW5=false;isHW6=false;isHW7=false;}
                if(ImGui::MenuItem("HW4", NULL, &isHW4))    {isHW2=false;isHW3=false;isHW5=false;isHW6=false;isHW7=false;}
                if(ImGui::MenuItem("HW5", NULL, &isHW5))    {isHW2=false;isHW3=false;isHW4=false;isHW6=false;isHW7=false;}
                if(ImGui::MenuItem("HW6", NULL, &isHW6))    {isHW2=false;isHW3=false;isHW4=false;isHW5=false;isHW7=false;}
                if(ImGui::MenuItem("HW7", NULL, &isHW7))    {isHW2=false;isHW3=false;isHW4=false;isHW5=false;isHW6=false;}
